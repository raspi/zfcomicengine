...
--
-- Palvelin: localhost
-- Luontiaika: 20.02.2009 klo 22:18
...
CREATE TABLE IF NOT EXISTS `COMMENTS` (
  `id` int(11) NOT NULL auto_increment,
  `nick` varchar(255) character set utf8 collate utf8_swedish_ci NOT NULL,
  `comment` varchar(255) character set utf8 collate utf8_swedish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `GUESTBOOK` (
  ...
  `question` text character set utf8 collate utf8_swedish_ci NOT NULL,
  `answer` text character set utf8 collate utf8_swedish_ci,
  `added` datetime NOT NULL,
  PRIMARY KEY  (`id`)
...
CREATE TABLE IF NOT EXISTS `PAGES` (
  ...
  `content` longtext character set utf8 collate utf8_swedish_ci NOT NULL,
